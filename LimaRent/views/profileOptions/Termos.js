...
export default function Termos({ navigation }) {
  return (
    <View>
      ...
      <Text style={{ fontSize: 45, marginTop: 10, alignSelf: 'center' }}>Termos e Condições </Text>
      ...
      <Text style={{ fontSize: 35, marginTop: 10, alignSelf: 'center' }}>Pagamento</Text>
      ...
      <Text style={{ fontSize: 35, marginTop: 10, alignSelf: 'center' }}>Validação de Documentos </Text>
